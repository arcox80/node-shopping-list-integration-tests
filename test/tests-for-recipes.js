...
describe('Recipes', function() {
  ...
  it('should add a recipe on POST', function() {
    const newItem = {name: 'pancakes', ingredients: ['1 cup mix', '1 egg', '1 cup milk']};
    return chai.request(app)
      .post('/recipes')
      .send(newItem)
      .then(function(res) {
  ...
  it('should update recipes on PUT', function() {
    ...
    const updateData = {
      name: 'fried rice',
      ingredients: ['1 cup white rice', '2 cups water', '1 egg', '1 tbsp vegetable oil', '1 cup peas, onions, chopped carrots']
    };
